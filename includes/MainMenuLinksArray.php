...
$MenuItems['GL']['Maintenance']['Caption'] = array(_('Account Sections'), _('Account Groups'), _('GL Accounts'), _('GL Account Authorised Users'), _('User Authorised GL Accounts'), _('Create/Amend General Ledger Budgets'), _('Create Budget Amounts'), _('GL Tags'), _('Bank Accounts'), _('Bank Account Authorised Users'), _('User Authorised Bank Accounts'), _('Maintain Journal Templates'));
$MenuItems['GL']['Maintenance']['URL'] = array('/AccountSections.php', '/AccountGroups.php', '/GLAccounts.php', '/GLAccountUsers.php', '/UserGLAccounts.php', '/GLBudgetHeaders.php', '/GLBudgets.php', '/GLTags.php', '/BankAccounts.php', '/BankAccountUsers.php', '/UserBankAccounts.php', '/GLJournalTemplates.php');
