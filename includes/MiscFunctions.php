...
function prnMsg($Msg, $Type = 'info', $Prefix = '') {
	switch ($Type) {
		case 'error':
			...
			echo '<div name="error" style="display:none;" class="' . $Class . ' noPrint"><b>' . $Prefix . '</b> : ' . $Msg . '</div>';
		break;
		case 'warn':
			$Class = 'warn';
			...
			echo '<br /><div name="warn" style="display:none;"><b>' . $Prefix . '</b> : ' . $Msg . '</div>';
		break;
		case 'success':
			$Class = 'success';
			...
			echo '<div name="success" style="display:none;"><b>' . $Prefix . '</b> : ' . $Msg . '</div>';
		break;
		case 'info':
		default:
			...
			echo '<div name="info" style="display:none;"><b>' . $Prefix . '</b> : ' . $Msg . '</div>';
	}
	} //prnMsg
